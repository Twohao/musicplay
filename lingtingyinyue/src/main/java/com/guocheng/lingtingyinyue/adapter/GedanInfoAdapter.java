 ...
 */
public class GedanInfoAdapter extends BaseAdapter {
    ...
    public GedanInfoAdapter(Context context,List<GedanMusicInfo.ContentEntity> contentEntityList){
        this.context = context;
        this.contentEntityList = contentEntityList;
    }
    @Override
    public int getCount() {
        return contentEntityList == null ? 0 : contentEntityList.size();
    }

    @Override
    public Object getItem(int position) {
        return contentEntityList == null ? null : contentEntityList.get(position);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvMusicTitle.setText(""+contentEntityList.get(position).getTitle());
        holder.tvMusicArtist.setText("" + contentEntityList.get(position).getAuthor());
